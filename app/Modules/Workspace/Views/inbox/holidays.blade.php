    ...
    <div class="max-w-4xl mx-auto">
                ...
                <div class="flex items-center gap-4">
                    ...
                    <div class="flex items-center gap-3">
                        <div class="w-12 h-12 rounded-lg bg-warning/10 flex items-center justify-center">
                            <span class="icon-[tabler--calendar-off] size-6 text-warning"></span>
                        </div>
                        <div>
                            <h1 class="text-2xl font-bold text-base-content">Holidays</h1>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div class="card bg-base-100 shadow">
                <div class="card-body">
                    <h2 class="card-title text-lg mb-4" id="holiday-form-title">
                        <span class="icon-[tabler--plus] size-5" id="holiday-form-icon"></span>
                    ...
                    <form id="holiday-form" onsubmit="submitHolidayForm(event)">
                        ...
                        <div class="space-y-4">
                            ...
                            <div class="form-control">
                                ...
                                <input type="text" name="name" id="holiday-name" class="input input-bordered" placeholder="e.g., Christmas Day, New Year" required>
                            </div>
                            ...
                            <div class="grid grid-cols-2 gap-4">
                                ...
                                <div class="form-control">
                                    ...
                                    <input type="text" name="date" id="holiday-date" class="input input-bordered" placeholder="Select date" required>
                                </div>
                                ...
                                <div class="form-control">
                                    ...
                                    <input type="number" name="working_hours" id="holiday-working-hours" class="input input-bordered" value="0" min="0" max="24" step="0.5">
                                    <label class="label">
                            ...
                            <div class="flex gap-2 pt-2">
                                <button type="submit" class="btn btn-warning flex-1 gap-2" id="holiday-submit-btn">
                                    <span class="icon-[tabler--plus] size-5" id="holiday-submit-icon"></span>
                                    <span id="holiday-submit-text">Add Holiday</span>
                                </button>
                                <button type="button" class="btn btn-ghost hidden" id="holiday-cancel-edit-btn" onclick="cancelEditHoliday()">
                                    Cancel
                                </button>
                            </div>
                            <div id="holiday-form-error" class="text-error text-sm hidden"></div>
                        </div>
                    </form>
                </div>
            </div>
            ...
            <div class="card bg-base-100 shadow">
                <div class="card-body">
                    ...
                    <div class="text-center py-8 text-base-content/50 {{ $holidays->count() > 0 ? 'hidden' : '' }}" id="no-holidays-msg">
                        ...
                        <p class="text-xs">Add your first holiday using the form</p>
                    </div>
                </div>
            </div>
        </div>
...
<div id="delete-holiday-modal" class="fixed inset-0 z-50 hidden">
...
function resetHolidayForm() {
    ...
    document.getElementById('holiday-form-icon').className = 'icon-[tabler--plus] size-5';
    document.getElementById('holiday-form-title-text').textContent = 'Add Holiday';
    document.getElementById('holiday-submit-icon').className = 'icon-[tabler--plus] size-5';
    ...
    document.getElementById('holiday-submit-btn').classList.add('btn-warning');
...
function editHoliday(holidayId) {
    ...
    document.getElementById('holiday-form-icon').className = 'icon-[tabler--edit] size-5';
    document.getElementById('holiday-form-title-text').textContent = 'Edit Holiday';
    document.getElementById('holiday-submit-icon').className = 'icon-[tabler--check] size-5';
    ...
    document.getElementById('holiday-submit-btn').classList.remove('btn-warning');
