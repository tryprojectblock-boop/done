...
<div class="flex gap-3" id="comment-{{ $comment->id }}">
    ...
    <div class="flex-1 pb-4 border-b border-[#EDECF0]">
        <div class="{{ $comment->is_private ? 'bg-warning/10 border-2 border-warning/50' : 'bg-transparrent' }} rounded-lg p-3 pt-0">
            ...
            <div class="flex items-center justify-between mb-1">
                <div class="flex flex-col gap-1">
                    <span class="text-sm text-[#B8B7BB]">{{ $comment->created_at->diffForHumans() }}</span>
                    <span class="font-base text-[#17151C]">{{ $comment->user->name }}</span>
                    
                    @if($comment->is_edited)
                        <span class="text-base text-[#525158]">(edited)</span>
                    @endif
                </div>
            </div>
        ...
        <!-- Action Buttons Row -->
        <div class="flex items-center gap-2 mt-1 pl-3">
