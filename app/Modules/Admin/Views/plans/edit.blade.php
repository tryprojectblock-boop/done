            ...
            <div class="card-body">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div class="form-control">
                        ...
                        <input type="text" name="name" value="{{ old('name', $plan->name) }}" class="input input-bordered @error('name') input-error @enderror" placeholder="e.g., Pro, Business, Enterprise" required />
                        @error('name')
            ...
            <div class="card-body">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <div class="form-control">
                        ...
                        <input type="number" name="workspace_limit" value="{{ old('workspace_limit', $plan->workspace_limit) }}" class="input input-bordered @error('workspace_limit') input-error @enderror" min="0" required />
                    ...
                    <div class="form-control">
                        ...
                        <input type="number" name="team_member_limit" value="{{ old('team_member_limit', $plan->team_member_limit) }}" class="input input-bordered @error('team_member_limit') input-error @enderror" min="0" required />
                    ...
                    <div class="form-control">
                        ...
                        <input type="number" name="storage_limit_gb" value="{{ old('storage_limit_gb', $plan->storage_limit_gb) }}" class="input input-bordered @error('storage_limit_gb') input-error @enderror" min="0" required />
