            ...
            <div class="card-body">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div class="form-control">
                        ...
                        <input type="text" name="name" value="{{ old('name') }}" class="input input-bordered @error('name') input-error @enderror" placeholder="e.g., Summer Sale, Black Friday" required />
                        @error('name')
                    ...
                    <div class="form-control">
                        ...
                        <input type="text" name="code" value="{{ old('code') }}" class="input input-bordered font-mono uppercase @error('code') input-error @enderror" placeholder="e.g., SUMMER2024" required />
                        <label class="label">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
                    <div class="form-control">
                        ...
                        <div class="join">
                            <input type="number" name="discount_percent" value="{{ old('discount_percent', 10) }}" class="input input-bordered join-item w-full @error('discount_percent') input-error @enderror" min="1" max="100" step="0.01" required />
                    ...
                    <div class="form-control">
                        ...
                        <input type="number" name="usage_limit" value="{{ old('usage_limit') }}" class="input input-bordered @error('usage_limit') input-error @enderror" min="1" placeholder="Leave empty for unlimited" />
                        <label class="label">
            ...
            <div class="card-body">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div class="form-control">
                        ...
                        <input type="date" name="start_date" value="{{ old('start_date', date('Y-m-d')) }}" class="input input-bordered @error('start_date') input-error @enderror" required />
                        @error('start_date')
                            <label class="label"><span class="label-text-alt text-error">{{ $message }}</span></label>
                        @enderror
                    </div>
                    ...
                    <div class="form-control">
                        ...
                        <input type="date" name="end_date" value="{{ old('end_date') }}" class="input input-bordered @error('end_date') input-error @enderror" />
                        <label class="label">
