        ...
        <div class="card-body">
            ...
            <form action="{{ route('backoffice.clients.update', $company) }}" method="POST">
                ...
                <div class="form-control mb-4">
                    ...
                    <input type="text" name="name" value="{{ old('name', $company->name) }}" class="input input-bordered @error('name') input-error @enderror" required />
                    @error('name')
                ...
                <div class="form-control mb-4">
                    ...
                    <input type="url" name="website_url" value="{{ old('website_url', $company->website_url) }}" class="input input-bordered @error('website_url') input-error @enderror" placeholder="https://example.com" />
                    @error('website_url')
                        <label class="label"><span class="label-text-alt text-error">{{ $message }}</span></label>
                    @enderror
                </div>
