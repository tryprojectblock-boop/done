            ...
            <div class="max-w-2xl mx-auto">
                ...
                <form action="{{ route('channels.store') }}" method="POST" class="space-y-6">
                    ...
                    <div class="form-control">
                        ...
                        <input type="text" name="name" value="{{ old('name') }}" placeholder="e.g., Marketing" class="input input-bordered @error('name') input-error @enderror" required maxlength="100" />
                        @error('name')
                    ...
                    <div class="form-control">
                        ...
                        <div class="relative">
                            ...
                            <input type="text" name="tag" value="{{ old('tag') }}" placeholder="admin resources" class="input input-bordered pl-8 w-full @error('tag') input-error @enderror" required maxlength="50" />
                        </div>
                        @error('tag')
                            <label class="label"><span class="label-text-alt text-error">{{ $message }}</span></label>
                        @enderror
                    ...
                    <div class="form-control">
                        ...
                        <textarea name="description" placeholder="Describe what this channel is about..." class="textarea textarea-bordered h-24 @error('description') textarea-error @enderror" maxlength="500">{{ old('description') }}</textarea>
                        @error('description')
                            <label class="label"><span class="label-text-alt text-error">{{ $message }}</span></label>
                        @enderror
                    </div>
