...
<div class="p-4 md:p-6">
    <div class="max-w mx-auto">
        ...
        <div class="inline-flex p-1 bg-base-200 rounded-xl mb-6">
            <a href="{{ route('discussions.index') }}" class="flex items-center gap-2 px-5 py-2.5 rounded-lg font-medium transition-all duration-200 bg-primary text-primary-content shadow-sm">
                <span class="icon-[tabler--message-circle] size-5"></span>
                <span>Discussion</span>
                @if(isset($discussions) && $discussions->total() > 0)
                    <span class="badge badge-sm bg-primary-content/20 text-primary-content border-0">{{ $discussions->total() }}</span>
                @endif
            </a>
            <a href="{{ route('channels.index') }}" class="flex items-center gap-2 px-5 py-2.5 rounded-lg font-medium transition-all duration-200 text-base-content/60 hover:text-primary hover:bg-primary/10">
