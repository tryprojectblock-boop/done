...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function getVisibleMemberOptions() { return Array.from(memberOptions).filter(opt => !opt.classList.contains('hidden')); }
    ...
    memberSearch.addEventListener('input', function() {
        ...
        let visibleCount = 0;
        memberOptions.forEach(option => { const name = option.dataset.search; if (name.includes(searchTerm)) { option.classList.remove('hidden'); visibleCount++; } else { option.classList.add('hidden'); } });
