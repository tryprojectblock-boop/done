...
<body>
    <div class="container">
        ...
        <p class="subtitle">{{ $invitedBy->full_name }} has invited you to join {{ config('app.name') }}</p>

        <div class="content">
            <p>Hi {{ $user->first_name }},</p>
            <p>You've been invited to join <strong>{{ $invitedBy->company->name ?? config('app.name') }}</strong> as a <span class="role-badge role-{{ $user->role }}">{{ $user->role_label }}</span>.</p>
            <p>Click the button below to complete your profile and join the team:</p>
        </div>
        ...
        <div class="expiry-note">
            <p><strong>Note:</strong> This invitation link will expire in 7 days. If it expires, please contact your team administrator to request a new invitation.</p>
        </div>
