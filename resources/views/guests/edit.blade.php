...
<div class="p-4 md:p-6">
    <div class="max-w-2xl mx-auto">
        ...
        <div class="mb-6">
            ...
            <h1 class="text-2xl font-bold text-base-content">Edit Guest</h1>
            <p class="text-base-content/60">Update {{ $guest->full_name }}'s information</p>
        </div>

        <!-- Form -->
        <form id="edit-guest-form" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            <div class="card bg-base-100 shadow">
                <div class="card-body">
                    ...
                    <div class="form-control">
                        ...
                        <input type="hidden" name="tags" id="tags-hidden" value="{{ $guest->tags ? implode(',', $guest->tags) : '' }}">
                        <label class="label">
...
document.getElementById('edit-guest-form').addEventListener('submit', function(e) {
    ...
    fetch('{{ route("guests.update", $guest) }}', {
        method: 'POST',
        body: formData,
        headers: {
